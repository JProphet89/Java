// $ANTLR 3.5.1 /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g 2014-05-12 00:51:41
	...
	import source.Concepts;
	import source.Hierarchies;
	import source.Relations;
	import source.Atributes;
	import source.Triples;
	import source.Ontologies;
...
public class OntoDLParser extends Parser {
	...
	// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:17:1: ontology returns [Ontologies ontology] : 'Ontology{' concepts hierarchies relations links[$concepts.list_concepts,$relations.list_relations] '}' ;
	public final Ontologies ontology() throws RecognitionException {
		...
		try {
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:21:2: ( 'Ontology{' concepts hierarchies relations links[$concepts.list_concepts,$relations.list_relations] '}' )
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:22:2: 'Ontology{' concepts hierarchies relations links[$concepts.list_concepts,$relations.list_relations] '}'
			{
	...
	// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:47:1: concepts returns [ArrayList <Concepts> list_concepts] : 'Concepts[' (cp1= concept ( ',' cp2= concept )* )? ']' ;
	public final ArrayList <Concepts> concepts() throws RecognitionException {
		...
		try {
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:51:2: ( 'Concepts[' (cp1= concept ( ',' cp2= concept )* )? ']' )
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:52:2: 'Concepts[' (cp1= concept ( ',' cp2= concept )* )? ']'
			{
			match(input,19,FOLLOW_19_in_concepts81); 
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:53:3: (cp1= concept ( ',' cp2= concept )* )?
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:53:4: cp1= concept ( ',' cp2= concept )*
					{
					...
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:53:59: ( ',' cp2= concept )*
					loop1:
					while (true) {
						int alt1=2;
						...
						switch (alt1) {
						case 1 :
							// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:53:60: ',' cp2= concept
							{
	...
	// $ANTLR start "concept"
	// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:57:1: concept returns [Concepts concep] : '{' c1= ID ( ',' 'Description(' description= STRING ')' )? ( ',' 'Attributes[' a1= atribute ( ',' a2= atribute )* ']' )? '}' ;
	public final Concepts concept() throws RecognitionException {
		...
		Atributes a2 =null;
			...
			concep =new Concepts();
			concep.atribute=new ArrayList<Atributes>();

		try {
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:62:2: ( '{' c1= ID ( ',' 'Description(' description= STRING ')' )? ( ',' 'Attributes[' a1= atribute ( ',' a2= atribute )* ']' )? '}' )
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:63:2: '{' c1= ID ( ',' 'Description(' description= STRING ')' )? ( ',' 'Attributes[' a1= atribute ( ',' a2= atribute )* ']' )? '}'
			{
			match(input,32,FOLLOW_32_in_concept125); 
			c1=(Token)match(input,ID,FOLLOW_ID_in_concept131); 
			concep.name=(c1!=null?c1.getText():null);
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:64:41: ( ',' 'Description(' description= STRING ')' )?
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:64:42: ',' 'Description(' description= STRING ')'
					{
			...
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:68:3: ( ',' 'Attributes[' a1= atribute ( ',' a2= atribute )* ']' )?
			int alt5=2;
			...
			switch (alt5) {
				case 1 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:68:4: ',' 'Attributes[' a1= atribute ( ',' a2= atribute )* ']'
					{
					...
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:68:71: ( ',' a2= atribute )*
					loop4:
					while (true) {
						int alt4=2;
						...
						switch (alt4) {
						case 1 :
							// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:68:72: ',' a2= atribute
							{
	...
	// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:72:1: atribute returns [Atributes atr] : '{' a1= ID ( 'float' | 'string' | 'int' | 'boolean' ) '}' ;
	public final Atributes atribute() throws RecognitionException {
		Atributes atr = null;
		...
		try {
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:76:2: ( '{' a1= ID ( 'float' | 'string' | 'int' | 'boolean' ) '}' )
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:77:2: '{' a1= ID ( 'float' | 'string' | 'int' | 'boolean' ) '}'
			{
			...
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:81:3: ( 'float' | 'string' | 'int' | 'boolean' )
			int alt6=4;
			switch ( input.LA(1) ) {
			case 27:
				{
			...
			switch (alt6) {
				case 1 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:81:4: 'float'
					{
					...
					break;
				case 2 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:81:41: 'string'
					{
					...
					break;
				case 3 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:81:80: 'int'
					{
					...
					break;
				case 4 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:81:113: 'boolean'
					{
	...
	// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:85:1: hierarchies returns [ArrayList <Hierarchies> list_hierarchies] : 'Hierarchies[' (h1= hierarchy ( ',' h2= hierarchy )* )? ']' ;
	public final ArrayList <Hierarchies> hierarchies() throws RecognitionException {
		...
		try {
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:89:2: ( 'Hierarchies[' (h1= hierarchy ( ',' h2= hierarchy )* )? ']' )
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:90:2: 'Hierarchies[' (h1= hierarchy ( ',' h2= hierarchy )* )? ']'
			{
			match(input,21,FOLLOW_21_in_hierarchies235); 
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:91:3: (h1= hierarchy ( ',' h2= hierarchy )* )?
			int alt8=2;
			...
			switch (alt8) {
				case 1 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:91:4: h1= hierarchy ( ',' h2= hierarchy )*
					{
					...
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:93:5: ( ',' h2= hierarchy )*
					loop7:
					while (true) {
						int alt7=2;
						...
						switch (alt7) {
						case 1 :
							// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:93:6: ',' h2= hierarchy
							{
	...
	// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:99:1: hierarchy returns [Hierarchies hierar] : '{' hi1= ID '>' hi2= ID '}' ;
	public final Hierarchies hierarchy() throws RecognitionException {
		...
		try {
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:103:2: ( '{' hi1= ID '>' hi2= ID '}' )
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:104:2: '{' hi1= ID '>' hi2= ID '}'
			{
	...
	// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:110:1: relations returns [ArrayList <Relations> list_relations] : 'Relations[' (re1= relation ( ',' re2= relation )* )? ']' ;
	public final ArrayList <Relations> relations() throws RecognitionException {
		...
		try {
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:114:2: ( 'Relations[' (re1= relation ( ',' re2= relation )* )? ']' )
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:115:2: 'Relations[' (re1= relation ( ',' re2= relation )* )? ']'
			{
			match(input,24,FOLLOW_24_in_relations310); 
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:116:3: (re1= relation ( ',' re2= relation )* )?
			int alt10=2;
			...
			switch (alt10) {
				case 1 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:116:4: re1= relation ( ',' re2= relation )*
					{
					...
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:116:59: ( ',' re2= relation )*
					loop9:
					while (true) {
						int alt9=2;
						...
						switch (alt9) {
						case 1 :
							// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:116:60: ',' re2= relation
							{
	...
	// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:120:1: relation returns [Relations rel] : '{' r1= ID ( ',Description(' r2= STRING ')' )? '}' ;
	public final Relations relation() throws RecognitionException {
		...
		try {
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:124:2: ( '{' r1= ID ( ',Description(' r2= STRING ')' )? '}' )
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:125:2: '{' r1= ID ( ',Description(' r2= STRING ')' )? '}'
			{
			...
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:127:3: ( ',Description(' r2= STRING ')' )?
			int alt11=2;
			...
			switch (alt11) {
				case 1 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:127:4: ',Description(' r2= STRING ')'
					{
	...
	// $ANTLR start "links"
	// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:133:1: links[ArrayList<Concepts> list_concepts,ArrayList<Relations> list_relations] returns [ArrayList<Triples> list_links,ArrayList<Concepts> list_concepts_out,ArrayList<Relations> list_relations_out] : 'Links[' (l1= link ( ',' l2= link )* )? ']' ;
	public final OntoDLParser.links_return links(ArrayList<Concepts> list_concepts, ArrayList<Relations> list_relations) throws RecognitionException {
		...
		try {
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:141:2: ( 'Links[' (l1= link ( ',' l2= link )* )? ']' )
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:142:2: 'Links[' (l1= link ( ',' l2= link )* )? ']'
			{
			match(input,22,FOLLOW_22_in_links393); 
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:143:3: (l1= link ( ',' l2= link )* )?
			int alt13=2;
			...
			switch (alt13) {
				case 1 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:143:4: l1= link ( ',' l2= link )*
					{
					...
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:160:4: ( ',' l2= link )*
					loop12:
					while (true) {
						int alt12=2;
						...
						switch (alt12) {
						case 1 :
							// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:160:5: ',' l2= link
							{
	...
	// $ANTLR start "link"
	// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:181:1: link returns [Triples lin] : '{' c1= ID r= ID ( 'min' min= INT )? ( 'max' max= INT )? c2= ID '}' ;
	public final Triples link() throws RecognitionException {
		...
		try {
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:185:2: ( '{' c1= ID r= ID ( 'min' min= INT )? ( 'max' max= INT )? c2= ID '}' )
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:186:2: '{' c1= ID r= ID ( 'min' min= INT )? ( 'max' max= INT )? c2= ID '}'
			{
			...
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:186:16: ( 'min' min= INT )?
			int alt14=2;
			...
			switch (alt14) {
				case 1 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:186:17: 'min' min= INT
					{
			...
			// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:186:33: ( 'max' max= INT )?
			int alt15=2;
			...
			switch (alt15) {
				case 1 :
					// /Users/jprophet89/masterthesisdoc/Owl2DSL/src/OntoDL.g:186:34: 'max' max= INT
					{
			...
			c2=(Token)match(input,ID,FOLLOW_ID_in_link464); 
					...
					if((min!=null?min.getText():null)!=null){
						...
						System.out.println("min cardinality="+Integer.parseInt((min!=null?min.getText():null)));
					}else{
						lin.min=0;
						System.out.println("min cardinality=0");
					}
					if((max!=null?max.getText():null)!=null){
						lin.max=Integer.parseInt((max!=null?max.getText():null));
						System.out.println("max cardinality="+Integer.parseInt((max!=null?max.getText():null)));
					}else{
						lin.max=0;
						System.out.println("max cardinality=0");
					}
